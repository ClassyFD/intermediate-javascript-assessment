...
String.prototype.grammarPolice = function() {
  ...
  for (var prop in this) {
    (this[prop].length > 0) ? arr.push(this[prop]) : null
  } 
    var newString= arr.join('').split(' ').map((e)=>{
...
function valueType(arg1, arg2){
  var statement = typeof arg1 === typeof arg2 && arg1 === arg2 ? 
  'Exactly the same' :  arg1 == arg2 ? 
  'Same value, different types' : 'Different values';
  return statement;
}
